...
import (
	...
	goonvif "github.com/eshun/onvif"
	"github.com/eshun/onvif/device"
	"github.com/eshun/onvif/gosoap"
	"github.com/eshun/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/eshun/onvif/gosoap for pretty printing response
		*/
