...
import (
	...
	"github.com/eshun/onvif"
	"github.com/eshun/onvif/gosoap"
	"github.com/eshun/onvif/networking"
	wsdiscovery "github.com/eshun/onvif/ws-discovery"
...
func callNecessaryMethod(serviceName, methodName, acceptedData, username, password, xaddr string) (string, error) {
	...
	servResp, err := networking.SendSoap(new(http.Client), endpoint, soap.String(), username, password, "")
	if err != nil {
		return "", err
	}
